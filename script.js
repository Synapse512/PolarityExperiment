...
let articles = [
    {
        ...
        testQuestions: [
            ...
            {
                q: "According to Ahmad et al. (2012), a preventive strategy (PS) is primarily aimed at what?",
                options: [
                    "“Preventing any attack, disclosure, or breach”",
            ...
            {
                q: "Why are preventive measures used by organizations?",
                options: [
                    "They are “required for all international businesses”",
                    "They are “designed for particularly vulnerable industries”",
                    "They are “only used by technology companies”"
                ],
                correct: 1
            },
            {
                q: "Which policy can promote preventive strategy (PS)?",
                options: [
            ...
            {
                q: "What is a benefit of training?",
                options: [
                    "It “increases the speed of data entry”",
                    "It “helps employees to avoid doing harm unintentionally”",
    ...
    },
    {
        ...
        testQuestions: [
            {
                q: "How many people around the world are impacted by asthma?",
                options: [
            ...
            {
                q: "What is the “primary reason” to decrease asthma control?",
                options: [
                    "“Poor adherence to asthma treatment”",
                    "“epithelial cell activation”",
                    "“exercise and obesity-induced asthma”"
                ],
                correct: 0
            },
            {
                q: "What are the costs of asthma healthcare in Europe and the U.S.?",
                options: [
                    "“$3,100 in Europe and $1,900 in the U.S.”",
                    "“$1,900 in Europe and $3,100 in the U.S.”",
                    "Same cost for both Europe and the U.S."
                ],
                correct: 1
            },
            {
                q: "What nursing intervention was shown to be moderately effective?",
                options: [
                    "“the use of patient education to teach inhaler techniques”",
                    "“monoclonal antibodies which target IL-5”",
                    "“acute healthcare visits”"
                ],
                correct: 0
            },
            {
                q: "In which group was education on inhaler techniques most effective on?",
                options: [
                    "“children”",
                    "“adults”",
